...
try:
    ...
    logger.warning("Could not load SageMaker imports.")
...
def run_finetuning_on_sagemaker(
    ...
    dataset_huggingface_workspace: str = "Nerdward",
    is_dummy: bool = False,
) -> None:
    ...
    huggingface_estimator = HuggingFace(
        ...
        instance_type="ml.g5.2xlarge",  # Cost-efficient instance with 24GB VRAM
        instance_count=1,
        ...
        use_spot_instances=True,  # Enables Spot instances for cost savings
        max_wait=36000,  # Time in seconds (e.g., 10 hours) to wait for a spot instance before failing
        max_run=28800,  # Max training time (e.g., 8 hours)
    )
