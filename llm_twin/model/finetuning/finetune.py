...
def check_if_huggingface_model_exists(
    model_id: str, default_value: str = "Nerdward/TwinLlama-3.1-8B"
) -> str:
    api = HfApi()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_huggingface_workspace", type=str, default="Nerdward")
    parser.add_argument(
        "--model_output_huggingface_workspace", type=str, default="Nerdward"
    )
    parser.add_argument(
        "--is_dummy",
        type=bool,
    ...
    if args.finetuning_type == "sft":
        ...
        base_model_name = "unsloth/Llama-3.1-8B"
