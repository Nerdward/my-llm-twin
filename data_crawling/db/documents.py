...
from data_crawling.db.mongo import connection
from data_crawling.errors import ImproperlyConfigured
from data_crawling.utils import get_logger

logger = get_logger(__name__)
_database = connection.get_database(settings.MONGO_DATABASE_HOST)
...
class BaseDocument(BaseModel):
    ...
    def get_or_create(cls, **filter_options) -> Optional[str]:
        ...
        try:
            ...
            logger.exception(f"Failed to retrieve document: {e}")
            return None
