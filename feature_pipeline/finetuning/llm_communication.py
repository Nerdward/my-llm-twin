...
MAX_LENGTH = 16384
SYSTEM_PROMPT = "You are a technical writer handling someone's account to post about AI and MLOps."
logger = get_logger(__name__)


class GptCommunicator:
    def __init__(self, gpt_model: str = "gpt-3.5-turbo") -> None:
    ...
    def send_prompt(self, prompt: str) -> list:
        try:
            ...
            logger.exception(f"Skipping batch! An error occurred while communication with API.")
            return []
